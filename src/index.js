...
function renderTask(title, date, priority) {
  ...
  <div class="task-right">
    ...
    <span class="task-edit"><img src="${Pencil}" alt="edit-icon"></span>
    <span class="task-delete"><img src="${Delete}" alt="edit-icon" class="delete-btn"></span>
  </div>`;
...
function renderNote(title, details) {
  ...
  <img src="${Delete}" alt="edit-icon" class="note-delete-btn">
